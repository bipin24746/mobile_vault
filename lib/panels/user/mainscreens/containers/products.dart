  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor:
            Colors.blueAccent, // Changed to blueAccent for consistency
      ),
      body: Column(
        children: [
          // Brand Filter Buttons
          Container(
            color: Colors.blueAccent, // Changed to blueAccent for consistency
          ...
          Container(
            color: Colors.blueAccent, // Changed to redAccent for consistency
            padding: EdgeInsets.symmetric(vertical: 8),
            child: SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: 14,
                                        color:
                                            Colors.blueAccent, // Adjusted color
                                      ),
                                    ),
                                  ],
                                ),
